...
| D5 | Appraisal engine module | `memory/appraisal_engine.py` | Python |
| D6 | EM-LLM episode manager | `memory/episode_manager.py` | Python |
| D7 | ACT-R retrieval scorer | `memory/activation_scorer.py` | Python |
| D8 | A-MEM knowledge graph | `memory/knowledge_graph.py` | Python |
| D9 | Diary memory store | `memory/diary_store.py` | Python |
| D10 | Reflection loop | `memory/reflection_loop.py` | Python |
| D11 | Consolidation job | `memory/consolidation.py` | Python |
| D12 | Tool schema store | `memory/tool_schema_store.py` | Python |
| D13 | Thread state manager | `memory/thread_state.py` | Python |
| D14 | Updated `core/main.py` | `core/main.py` | Python (modified) |
| D15 | Updated constants/config | `core/constants.py`, `core/config.py` | Python (modified) |
| D16 | Test suite | `tests/test_memory_v2.py` | Python |
| D17 | Integration test | `tests/test_memory_integration.py` | Python |
...
Each week ends with a smoke test confirming no regression on existing `tests/` suite.
